        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-white p-6 rounded-2xl border-2 border-gray-200 flex justify-between items-center">
                ...
                <button
                    ...
                    className="text-gray-400 hover:text-duo-red-dark transition-colors rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-duo-red"
                >
                    <XCircle size={28} />
                </button>
            </div>
